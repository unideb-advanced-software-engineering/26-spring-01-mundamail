...
## Government Messaging System Architecture

<a href="/diagrams/index.html#/view/systemContextDiagram/" target="_blank">Open diagram in full screen →</a>

<iframe 
  src="/diagrams/index.html#/view/systemContextDiagram/"
  width="100%"
  height="85vh"
  frameborder="0"
  style="border: 1px solid #e5e7eb; border-radius: 8px; margin-top: 1rem; min-height: 800px;"
/>
